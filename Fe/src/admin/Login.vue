...
<div id="login-admin">
    <div class="login-content">
        ...
        <b-form-group class="mb-3" label="Tài khoản" label-for="admin-user" valid-feedback="Tài khoản hợp lệ!">
            <b-form-input class="mt-2" id="admin-user" v-model="email" trim></b-form-input>
        </b-form-group>

        <b-form-group label="Mật khẩu" label-for="admin-pass" valid-feedback="Mật khẩu hợp lệ!" :invalid-feedback="invalidPassword" :state="pass">
            <b-form-input class="mt-2" type="password" id="admin-pass" v-model="password" :state="pass" trim></b-form-input>
        </b-form-group>
